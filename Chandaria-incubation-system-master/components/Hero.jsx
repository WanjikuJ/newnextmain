  ...
  return (
    <div className="relative pt-20 h-[60vh] w-full bg-black/20 overflow-hidden">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <img src="/chandaria building.png" alt="" className="w-full h-full opacity-30 " />
      </div>
      {/* Text overlay */}
      <div
        data-aos="fade-right"
...
Supporting young and creative ideas for a better tomorrow.       </p>
        <br />
        <Link href="/">
        <button className='bg-green-600 text-white py-2 px-4 rounded-full m-3.5 hover:bg-green-400'>Home</button>
